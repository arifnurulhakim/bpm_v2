    ...
    columns: [
        ...
        {data: 'email'},
        {
            ...
            render: function(data, type, row) {
                // Membuat objek untuk mencocokkan nilai level dengan nama yang sesuai
                var levelMap = {
                    '1': 'Super Admin',
                    '2': 'Admin',
                    '3': 'Sperpart'
                    // Tambahkan nilai-nilai level lain yang diperlukan di sini
                };

                // Mengembalikan nama level sesuai dengan nilai
