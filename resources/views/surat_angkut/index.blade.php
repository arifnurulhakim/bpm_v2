...
<button onclick="addForm('{{ route('surat_angkut.store') }}')" class="btn btn-success btn-xs btn-flat"><i
    class="fa fa-plus-circle"></i> Tambah</button>

<a href="{{ route('surat_angkut.exportCSV') }}" class="btn btn-primary btn-xs btn-flat"><i
...
$('#modal-form .modal-title').text('Tambah Surat Angkut');
...
$('#modal-form .modal-title').text('Edit Surat Angkut');
